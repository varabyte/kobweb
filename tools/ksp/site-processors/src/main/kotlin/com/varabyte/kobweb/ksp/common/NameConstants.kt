...
const val COMPONENT_KIND_SIMPLE_NAME = "ComponentKind"
const val COMPONENT_KIND_FQN = "${KOBWEB_SILK_FQN_PREFIX}style.component.$COMPONENT_KIND_SIMPLE_NAME"
const val COMPONENT_STYLE_SIMPLE_NAME = "ComponentStyle"
const val LEGACY_COMPONENT_STYLE_FQN = "${KOBWEB_SILK_FQN_PREFIX}components.style.$COMPONENT_STYLE_SIMPLE_NAME"
const val COMPONENT_STYLE_FQN = "${KOBWEB_SILK_FQN_PREFIX}style.component.$COMPONENT_STYLE_SIMPLE_NAME"
const val COMPONENT_VARIANT_SIMPLE_NAME = "ComponentVariant"
const val LEGACY_COMPONENT_VARIANT_FQN = "${KOBWEB_SILK_FQN_PREFIX}components.style.$COMPONENT_VARIANT_SIMPLE_NAME"
const val COMPONENT_VARIANT_FQN = "${KOBWEB_SILK_FQN_PREFIX}style.component.$COMPONENT_VARIANT_SIMPLE_NAME"
const val KEYFRAMES_SIMPLE_NAME = "Keyframes"
const val LEGACY_KEYFRAMES_FQN = "${KOBWEB_SILK_FQN_PREFIX}components.animation.$KEYFRAMES_SIMPLE_NAME"
const val KEYFRAMES_FQN = "${KOBWEB_SILK_FQN_PREFIX}style.animation.$KEYFRAMES_SIMPLE_NAME"
const val CSS_STYLE_SIMPLE_NAME = "CssStyle"
const val CSS_STYLE_FQN = "${KOBWEB_SILK_FQN_PREFIX}style.$CSS_STYLE_SIMPLE_NAME"
