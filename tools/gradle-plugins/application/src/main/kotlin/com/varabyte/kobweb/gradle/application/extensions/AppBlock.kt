 ...
 */
abstract class AppBlock @Inject constructor(conf: KobwebConf, baseGenDir: Property<String>) : FileGeneratingBlock {
    /**
     * A sub-block for defining properties related to the "index.html" document generated by Kobweb
     */
...
internal fun KobwebBlock.createAppBlock(conf: KobwebConf) {
    (this as ExtensionAware).extensions.create<AppBlock>("app", conf, baseGenDir)
}
