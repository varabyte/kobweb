...
fun <T : StylePropertyValue> StyleVariable(defaultFallback: T? = null, prefix: String? = null) = com.varabyte.kobweb.compose.css.StyleVariable(defaultFallback, prefix)

fun <T : StylePropertyValue> Modifier.setVariable(variable: com.varabyte.kobweb.compose.css.StyleVariable<T>, value: T) = styleModifier {
