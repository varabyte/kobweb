...
fun Modifier.animationComposition(animationComposition: AnimationComposition) = styleModifier {
    animationComposition(animationComposition)
}

fun Modifier.animationComposition(vararg compositions: AnimationComposition.Listable) = animationComposition(AnimationComposition.list(*compositions))
fun Modifier.animationComposition(compositions: List<AnimationComposition.Listable>) = animationComposition(*compositions.toTypedArray())
