...
class CssStylePropertyTests {
    ...
    fun verifyAspectRatio() {
        ...
        assertThat(styleToText { aspectRatio(AspectRatio.Auto( 1.5)) }).isEqualTo("aspect-ratio: auto 1.5")
        assertThat(styleToText { aspectRatio(AspectRatio.Auto(16, 9)) }).isEqualTo("aspect-ratio: auto 16 / 9")
