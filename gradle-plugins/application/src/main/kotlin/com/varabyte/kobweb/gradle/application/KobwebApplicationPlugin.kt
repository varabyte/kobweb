...
class KobwebApplicationPlugin @Inject constructor(
    ...
    override fun apply(project: Project) {
        ...
        val kobwebCleanExportTask = project.tasks.register("kobwebCleanExport", KobwebTask::class.java, "Cleans any artifacts generated by a previous export")
        kobwebCleanExportTask.configure {
            doLast {
                project.delete(kobwebConf.server.files.prod.siteRoot, kobwebFolder.resolve("server"))
            }
        }
        ...
        project.afterEvaluate {
            ...
            val cleanTask = project.tasks.named("clean") {
                dependsOn(kobwebCleanExportTask)
            }
