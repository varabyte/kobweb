![version: 0.7.4](https://img.shields.io/badge/kobweb-v0.7.4-yellow)
...
$ wget https://github.com/varabyte/kobweb/releases/download/v0.7.4/kobweb-0.7.4.zip
...
```bash
$ PATH=$PATH:/path/to/applications/kobweb/kobweb-0.7.4/bin
...
$ ln -s /path/to/applications/kobweb/kobweb-0.7.4/bin/kobweb kobweb
```
