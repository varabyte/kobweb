![version: 0.7.9](https://img.shields.io/badge/kobweb-v0.7.9-yellow)
...
$ wget https://github.com/varabyte/kobweb/releases/download/v0.7.9/kobweb-0.7.9.zip
$ unzip kobweb-0.7.9.zip
```

and I recommend adding it to your path, either directly:

```bash
$ PATH=$PATH:/path/to/applications/kobweb/kobweb-0.7.9/bin
...
$ ln -s /path/to/applications/kobweb/kobweb-0.7.9/bin/kobweb kobweb
```
