![version: 0.6.2](https://img.shields.io/badge/kobweb-v0.6.2-yellow)
...
$ wget https://github.com/varabyte/kobweb/releases/download/v0.6.2/kobweb-0.6.2.zip
$ unzip kobweb-0.6.2.zip
```

and I recommend adding it to your path, either directly:

```bash
$ PATH=$PATH:/path/to/applications/kobweb/kobweb-0.6.2/bin
...
$ ln -s /path/to/applications/kobweb/kobweb-0.6.2/bin/kobweb kobweb
```
