[![version: 0.23.1](https://img.shields.io/badge/kobweb-0.23.1-blue)](COMPATIBILITY.md)
[![version: 0.9.20](https://img.shields.io/badge/kobweb_cli-0.9.20-blue)](https://github.com/varabyte/kobweb-cli)
<br>
...
[grab the zip or tar file from GitHub](https://github.com/varabyte/kobweb-cli/releases/tag/v0.9.20) or you can fetch
...
| Downloaded from<br>Github | Visit the [latest release](https://github.com/varabyte/kobweb-cli/releases/tag/v0.9.20). You can find both a zip and tar file there. |
