![version: 0.9.11](https://img.shields.io/badge/kobweb-v0.9.11-blue)
![version: 0.9.8](https://img.shields.io/badge/kobweb_cli-v0.9.8-blue)
...
$ wget https://github.com/varabyte/kobweb/releases/download/cli-v0.9.8/kobweb-0.9.8.zip
$ unzip kobweb-0.9.8.zip

# ... or the tar file

$ wget https://github.com/varabyte/kobweb/releases/download/cli-v0.9.8/kobweb-0.9.8.tar
$ tar -xvf kobweb-0.9.8.tar
```

and I recommend adding it to your path, either directly:

```bash
$ PATH=$PATH:/path/to/applications/kobweb-0.9.8/bin
...
$ ln -s /path/to/applications/kobweb-0.9.8/bin/kobweb kobweb
```
