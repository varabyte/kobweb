![version: 0.9.7](https://img.shields.io/badge/kobweb-v0.9.7-blue)
![version: 0.9.6](https://img.shields.io/badge/kobweb_cli-v0.9.6-blue)
...
$ wget https://github.com/varabyte/kobweb/releases/download/cli-v0.9.6/kobweb-0.9.6.zip
$ unzip kobweb-0.9.6.zip

# ... or the tar file

$ wget https://github.com/varabyte/kobweb/releases/download/cli-v0.9.6/kobweb-0.9.6.tar
$ tar -xvf kobweb-0.9.6.tar
```

and I recommend adding it to your path, either directly:

```bash
$ PATH=$PATH:/path/to/applications/kobweb-0.9.6/bin
...
$ ln -s /path/to/applications/kobweb-0.9.6/bin/kobweb kobweb
```
