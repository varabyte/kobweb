[![kobweb: 0.25.2](https://img.shields.io/badge/kobweb-0.25.2-blue)](COMPATIBILITY.md)
[![kobweb-cli: 0.9.23](https://img.shields.io/badge/kobweb_cli-0.9.23-blue)](https://github.com/varabyte/kobweb-cli)
<br>
[![kotlin: 2.4.10](https://img.shields.io/badge/kotlin-2.4.10-blue?logo=kotlin)](COMPATIBILITY.md)
[![compose-html: 1.11.1](https://img.shields.io/badge/compose_html-1.11.1-blue?logo=jetpackcompose)](COMPATIBILITY.md)
[![compose-runtime: 1.12.0](https://img.shields.io/badge/compose_runtime-1.12.0-blue?logo=jetpackcompose)](COMPATIBILITY.md)
<br>
...
[grab the zip or tar file from GitHub](https://github.com/varabyte/kobweb-cli/releases/tag/v0.9.23) or you can fetch
...
$ wget https://github.com/varabyte/kobweb-cli/releases/download/v0.9.23/kobweb-0.9.23.zip
$ unzip kobweb-0.9.23.zip

# ... or the tar file

$ wget https://github.com/varabyte/kobweb-cli/releases/download/v0.9.23/kobweb-0.9.23.tar
$ tar -xvf kobweb-0.9.23.tar
```

and I recommend adding it to your path, either directly:

```bash
$ PATH=$PATH:/path/to/applications/kobweb-0.9.23/bin
...
$ ln -s /path/to/applications/kobweb-0.9.23/bin/kobweb kobweb
```
...
| Downloaded from<br>Github | Visit the [latest release](https://github.com/varabyte/kobweb-cli/releases/tag/v0.9.23). You can find both a zip and tar file there.                                    |
