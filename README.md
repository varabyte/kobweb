![version: 0.10.5](https://img.shields.io/badge/kobweb-0.10.5-blue)
...
![Mastodon Follow](https://img.shields.io/mastodon/follow/109286410344376068?domain=https%3A%2F%2Fandroiddev.social&style=social)
...
$ wget https://github.com/varabyte/kobweb/releases/download/cli-v0.9.9/kobweb-0.9.9.tar
$ tar -xvf kobweb-0.9.9.tar
```

and I recommend adding it to your path, either directly:

```bash
$ PATH=$PATH:/path/to/applications/kobweb-0.9.9/bin
...
$ ln -s /path/to/applications/kobweb-0.9.9/bin/kobweb kobweb
```
