![version: 0.7.8](https://img.shields.io/badge/kobweb-v0.7.8-yellow)
...
$ wget https://github.com/varabyte/kobweb/releases/download/v0.7.8/kobweb-0.7.8.zip
...
```bash
$ PATH=$PATH:/path/to/applications/kobweb/kobweb-0.7.8/bin
...
$ ln -s /path/to/applications/kobweb/kobweb-0.7.8/bin/kobweb kobweb
```
