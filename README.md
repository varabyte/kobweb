[![version: 0.19.3](https://img.shields.io/badge/kobweb-0.19.3-blue)](COMPATIBILITY.md)
[![version: 0.9.17](https://img.shields.io/badge/kobweb_cli-0.9.17-blue)](https://github.com/varabyte/kobweb-cli)
<br>
...
[grab the zip or tar file from GitHub](https://github.com/varabyte/kobweb-cli/releases/tag/v0.9.17) or you can fetch
...
$ wget https://github.com/varabyte/kobweb-cli/releases/download/v0.9.17/kobweb-0.9.17.zip
$ unzip kobweb-0.9.17.zip

# ... or the tar file

$ wget https://github.com/varabyte/kobweb-cli/releases/download/v0.9.17/kobweb-0.9.17.tar
$ tar -xvf kobweb-0.9.17.tar
```

and I recommend adding it to your path, either directly:

```bash
$ PATH=$PATH:/path/to/applications/kobweb-0.9.17/bin
...
$ ln -s /path/to/applications/kobweb-0.9.17/bin/kobweb kobweb
```
...
| Downloaded from<br>Github | Visit the [latest release](https://github.com/varabyte/kobweb-cli/releases/tag/v0.9.17). You can find both a zip and tar file there. |
